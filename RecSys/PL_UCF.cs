...
{
    /// <summary>
    /// class for power law distribution
    /// 参数在matlab中进行拟合
    /// </summary>
    class PL_UCF
    {
            ...
            double a, double b)
        {
            ...
            foreach (var item in candi)//防止枚举报错，交叉取list
            {
                ...
                pl_dic[item.Key] = pl_dic[item.Key] / pl_max;
                //t = pl_dic[item.Key];
            }
        ...
        public void recommend_all(int n, double a, double b)
        {
            ...
            foreach (var user in usercheckins)
            {
                ...
                //{
                //    DataTableToCSV(dt, "D:/dissertation/data/result/recommendation_PLX_UCF_20160317_" + user_count + ".csv");
                //}
            }

            DataTableToCSV(dt, "D:/dissertation/data/result/recommendation_PL_UCF_20160320_" + n + "_" + a + "_" + b + ".csv");
        }
